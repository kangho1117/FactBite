...
매일 새로운 지식과 웃음을 한입 크기로 즐기는 프리미엄 웹 서비스 **FactBite**입니다. 

---

## 🌟 주요 특징 (Features)

- **2,000개의 풍부한 데이터셋**: 엄선된 상식 1,000개와 재미있는 농담 1,000개가 정밀 정제되어 포함되어 있습니다.
- **감각적인 프리미엄 디자인**: 다이내믹한 오로라 배경 백그라운드(Glassmorphism)와 부드러운 트랜지션 애니메이션을 제공합니다.
- **직관적인 모드 스위치**: 상단 토글을 통해 상식 모드와 농담 모드를 부드럽게 전환할 수 있습니다.
- **상세 설명 확장 (Detail)**: 요약본 하단의 `자세히` 버튼을 누르면 사실에 대한 상세한 맥락이나 농담의 펀치라인을 펼쳐 볼 수 있습니다.
- **키보드 단축키 지원**:
